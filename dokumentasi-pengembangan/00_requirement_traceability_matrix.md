...
| 18 | REQ-018 | Property Panel untuk Query Vector Node: edit vector queries | 2b | ✅ Selesai | `lib/panels/query_vector_panel.dart` |
...
| 36 | REQ-036 | Ekspor diagram ke format PNG resolusi tinggi | 4b | ✅ Selesai | `lib/export/exporter.dart` |
| 37 | REQ-037 | Ekspor diagram ke format SVG | 4b | ✅ Selesai | `lib/export/exporter.dart` |
| 38 | REQ-038 | Ekspor/Impor diagram ke format JSON | 4b | ✅ Selesai | `lib/export/exporter.dart` |
